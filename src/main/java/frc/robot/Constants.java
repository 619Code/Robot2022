...
public final class Constants {
    ...
    //Drive constants
    public static final double WHEEL_DIAMETER = Units.inchesToMeters(0.1480058); //meters
    ...
    public static final double TRACK_WIDTH = Units.inchesToMeters(0.5842); //distance between wheels in meters
    ...
    public static final double CLIMB_WINCH_DIAMETER = Units.inchesToMeters(0.0244856); // meters, diameter of climb winch
